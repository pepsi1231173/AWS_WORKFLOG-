...
- Complete Lab 11: practice core AWS services through the console, including S3, SNS, IAM, VPC, subnets, route table, internet gateway, security group, key pair, and EC2.
- Complete Lab 14: practice VM Import/Export, imported AMI, EC2 launch from imported AMI, snapshot/export buckets, and cleanup verification.
- Document console evidence for service creation, import workflow, and resource cleanup.

### Tasks to be carried out this week:

| Day | Task | Start Date | Completion Date | Status |
| --- | ---- | ---------- | --------------- | ------ |
| 2 | - Lab 11: create/check S3 bucket object and SNS topic. <br> - Create IAM user and IAM group. | 01/06/2026 | 01/06/2026 | Done |
| 3 | - Lab 11: create/check VPC, subnets, route table, internet gateway, and security group. | 02/06/2026 | 02/06/2026 | Done |
| 4 | - Lab 11: create key pair, launch EC2 instance, and verify cleanup evidence. | 03/06/2026 | 03/06/2026 | Done |
| 5 | - Lab 14: prepare S3 buckets and VM import IAM role. <br> - Verify imported AMI and imported snapshot. | 04/06/2026 | 04/06/2026 | Done |
| 6 | - Lab 14: launch EC2 from imported AMI and review export/import bucket evidence. | 05/06/2026 | 05/06/2026 | Done |
| 7 | - Lab 14: clean up EC2, S3, AMI, snapshot, security group, and vmimport role resources. | 06/06/2026 | 06/06/2026 | Done |

### Week 7 Achievements:

### Lab 11:

- Practiced creating and checking S3 bucket objects and SNS topic resources.
- Created IAM user and IAM group for access management practice.
- Created VPC networking resources: subnets, route table, internet gateway, and security group.
- Created key pair and launched EC2 instance from the AWS Console.
- Verified cleanup evidence for VPC-related resources.

### Lab 14:

- Prepared S3 buckets and IAM vmimport role for VM Import/Export workflow.
- Verified imported AMI and imported snapshot evidence.
- Launched EC2 instance from imported AMI.
- Reviewed export/import bucket evidence.
- Verified cleanup for EC2, S3, AMI, snapshot, security group, and vmimport role resources.

### Lab Evidence:

#### aws-lab-000011 - Core AWS services practice with S3, SNS, IAM, VPC, and EC2 (12 images)
...
#### aws-lab-000014 - VM Import/Export, imported AMI, EC2 launch, and cleanup verification (14 images)
