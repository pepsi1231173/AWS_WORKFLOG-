---
title: 'Week 6 - CloudWatch Monitoring and AWS Support'
date: 2026-05-31
weight: 6
chapter: false
pre: ' <b> 1.6. </b> '
...
- Complete Lab 8: deploy resources with CloudFormation and configure EC2 monitoring using CloudWatch metrics, logs, metric filters, alarms, and dashboards.
- Complete Lab 9: explore AWS Support Center, support plans, support case creation, and support interaction workflow.
- Capture evidence for monitoring, alerting, dashboard, and support case steps.

### Tasks to be carried out this week:

| Day | Task | Start Date | Completion Date | Status |
| --- | ---- | ---------- | --------------- | ------ |
| 2 | - Lab 8: deploy CloudFormation stack and verify EC2 instances. | 25/05/2026 | 25/05/2026 | Done |
| 3 | - Lab 8: review EC2 metrics, CloudWatch Agent metrics, log groups, and log streams. | 26/05/2026 | 26/05/2026 | Done |
| 4 | - Lab 8: create metric filter, configure alarm, and build CloudWatch dashboard. | 27/05/2026 | 27/05/2026 | Done |
| 5 | - Lab 9: open AWS Support Center, review existing cases, and compare support plans. | 28/05/2026 | 28/05/2026 | Done |
| 6 | - Lab 9: create a support case draft, fill subject/description, select service, category, and severity. | 29/05/2026 | 29/05/2026 | Done |
| 7 | - Lab 9: review support interaction response, communication preference, and final case evidence. | 30/05/2026 | 30/05/2026 | Done |

### Week 6 Achievements:

### Lab 8:

- Deployed a CloudFormation stack and verified the created EC2 resources.
- Reviewed EC2 metrics and CloudWatch Agent metrics.
- Inspected log groups, log streams, and filtered logs in CloudWatch Logs.
- Created metric filters, alarms, and a dashboard for monitoring evidence.

### Lab 9:

- Reviewed AWS Support Center home and support cases list.
- Compared available AWS support plans and support plan page details.
- Practiced filling a support case with subject, description, service, category, and severity.
- Reviewed support interaction response and final form evidence.

### Lab Evidence:

#### aws-lab-000008 - CloudFormation, EC2 monitoring, CloudWatch logs, alarms, and dashboard (12 images)
...
#### aws-lab-000009 - AWS Support Center, support plans, and support case workflow (12 images)
