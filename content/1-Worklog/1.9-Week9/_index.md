---
title: 'Week 9 - Lobby Map, 2D Collider Setup, and Multiplayer Systems'
date: 2024-06-21
weight: 9
chapter: false
pre: ' <b> 1.9. </b> '
...
- Design the Lobby Scene UI, draw the game map, set up collider boundaries for a top-down 2D map, and learn about online game mechanisms.
...
| 5 , 6 , 7 | - Design the UI and game map <br>&emsp; + Character position when entering the Lobby <br>&emsp; + Join Room panel <br>&emsp; + Room code input field <br>&emsp; + Start Game button <br>&emsp; + Exit to Menu button <br>&emsp; + Top-down 2D map layout <br>&emsp; + Collider setup for map boundaries and obstacle areas <br> - Implement the logic for these functions | 18/06/2026 | 20/06/2026      | In Progress |
...
- Drew and arranged the 2D top-down game map layout in Unity, including the playable area, object positions, and movement paths.
- Set up colliders for the map boundaries and obstacle areas so the player could move correctly without passing through blocked objects.
